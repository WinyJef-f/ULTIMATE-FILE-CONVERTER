...
public sealed class DependencyService
{
    ...
    private static IReadOnlyList<Dependency> BuildRequired()
    {
        ...
        return new[]
        {
            ...
            new Dependency("Ghostscript", "ArtifexSoftware.GhostScript", "gswin64c.exe",
                new[] { System.IO.Path.Combine(programFiles, "gs"), System.IO.Path.Combine(programFilesX86, "gs") },
                "Lets ImageMagick read PDF files (PDF → image)."),
