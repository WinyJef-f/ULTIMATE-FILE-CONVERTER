...
Markdown, and subtitle files are written as text. A built-in SRT<->SBV round-trip self-test
mirrors the in-app SubtitleConverter so the generated subtitle samples stay valid.
"""
